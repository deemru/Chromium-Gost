...
github-release upload --user deemru --repo chromium-gost --tag %CHROMIUM_TAG% --name chromium-gost-%CHROMIUM_TAG%-windows-386.msi --file RELEASE32\chromium-gost-%CHROMIUM_TAG%-windows-386.msi
