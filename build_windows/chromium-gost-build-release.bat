...
cd %CHROMIUM_PATH%
call gn gen out\RELEASE --args="is_debug=false is_cfi=false symbol_level=0 strip_debug_info=true is_official_build=true ffmpeg_branding=\"Chrome\" proprietary_codecs=true %CHROMIUM_PRIVATE_ARGS% target_cpu=\"x86\""
