...
cp -f $CHROMIUM_GOST_REPO/extra/colored_header.svg chrome/browser/resources/local_ntp/icons/colored_header.svg
cp -f $CHROMIUM_GOST_REPO/extra/header.svg chrome/browser/resources/local_ntp/icons/header.svg
cp -f $CHROMIUM_GOST_REPO/extra/header.svg chrome/browser/resources/new_tab_page/icons/header.svg
cp -f $CHROMIUM_GOST_REPO/extra/chromium-gost.svg ui/webui/resources/images/google_logo.svg
